...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class CreateScheduleResponseSchedule {
    /// <summary>
    /// Gets or Sets Name
    /// </summary>
    ...
    public CreateScheduleResponseScheduleFrequencyDetails FrequencyDetails { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class CreateScheduleResponseSchedule {\n");
