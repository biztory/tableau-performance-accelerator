...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class UpdateScheduleResponseScheduleFrequencyDetailsIntervalsInterval {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class UpdateScheduleResponseScheduleFrequencyDetailsIntervalsInterval {\n");
