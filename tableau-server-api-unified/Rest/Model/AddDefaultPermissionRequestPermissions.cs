...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class AddDefaultPermissionRequestPermissions {
    /// <summary>
    ...
    public AddDefaultPermissionRequestPermissionsGranteeCapabilities GranteeCapabilities { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class AddDefaultPermissionRequestPermissions {\n");
