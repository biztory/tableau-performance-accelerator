...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class GetWorkbookRevisionResponseRevision {
    /// <summary>
    ...
    public GetWorkbookRevisionResponseRevisionsRevisionUser User { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class GetWorkbookRevisionResponseRevision {\n");
