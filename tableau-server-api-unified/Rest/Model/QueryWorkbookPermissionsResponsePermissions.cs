...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class QueryWorkbookPermissionsResponsePermissions {
    /// <summary>
    /// Gets or Sets Workbook
    /// </summary>
    [DataMember(Name="workbook", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "workbook")]
    public QueryWorkbookPermissionsResponseWorkbook Workbook { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class QueryWorkbookPermissionsResponsePermissions {\n");
