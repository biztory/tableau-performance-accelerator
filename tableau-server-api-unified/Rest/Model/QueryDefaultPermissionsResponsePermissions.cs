...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class QueryDefaultPermissionsResponsePermissions {
    /// <summary>
    /// Gets or Sets Project
    /// </summary>
    [DataMember(Name="project", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "project")]
    public QueryDefaultPermissionsResponsePermissionsProject Project { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class QueryDefaultPermissionsResponsePermissions {\n");
