...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class CreateScheduleResponseScheduleFrequencyDetailsIntervalsInterval {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class CreateScheduleResponseScheduleFrequencyDetailsIntervalsInterval {\n");
