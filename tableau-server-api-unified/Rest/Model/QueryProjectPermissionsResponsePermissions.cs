...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class QueryProjectPermissionsResponsePermissions {
    /// <summary>
    /// Gets or Sets Project
    /// </summary>
    [DataMember(Name="project", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "project")]
    public QueryProjectPermissionsResponsePermissionsProject Project { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class QueryProjectPermissionsResponsePermissions {\n");
