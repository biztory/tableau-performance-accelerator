...
namespace Biztory.EnterpriseToolkit.TableauServerUnifiedApi.Rest.Model {
  ...
  /// </summary>
  [DataContract]
  public class AddDatasourcePermissionsResponsePermissions {
    /// <summary>
    /// Gets or Sets Datasource
    /// </summary>
    [DataMember(Name="datasource", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "datasource")]
    public AddDatasourcePermissionsResponsePermissionsDatasource Datasource { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class AddDatasourcePermissionsResponsePermissions {\n");
